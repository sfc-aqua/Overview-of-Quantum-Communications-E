...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.85\textwidth]{Figures/Chapter12/BW/12-1_all_to_all_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/Chapter12/BW/12-2_MIM_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.85\textwidth]{Figures/Chapter12/BW/12-2_MM_MSM_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/Chapter12/BW/12-3_entanglement_swapping_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/Chapter12/BW/12-4_purification_BW.pdf}
...
\begin{table}[t]
    ...
    \begin{tabular}{cccccc}
        ...
        \hline
        $\left|\Phi^{+}\right\rangle$ & $\left|\Phi^{+}\right\rangle$ & $F^{2}$ & 00 or 11 & Keep & $\left|\Phi^{+}\right\rangle$ \\
        $\left|\Phi^{+}\right\rangle$ & $\left|\Psi^{+}\right\rangle$ & $F(1-F)$ & 01 or 10 & Discard & N/A \\
        $\left|\Psi^{+}\right\rangle$ & $\left|\Phi^{+}\right\rangle$ & $(1-F) F$ & 01 or 10 & Discard & N/A \\
        $\left|\Psi^{+}\right\rangle$ & $\left|\Psi^{+}\right\rangle$ & $(1-F)^{2}$ & 00 or 11 & Keep & $\left|\Psi^{+}\right\rangle$ \\
        \hline
    \end{tabular}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/Chapter12/BW/12-5_routing_multiplexing_BW.pdf}
