...
\begin{figure}[t]
   \centering
    \includegraphics[width=0.8\textwidth]{Figures/Chapter06/Color/mach_zehnder.pdf}
...
\begin{figure}[t]
   \centering
    \includegraphics[width=0.8\textwidth]{Figures/Chapter06/Color/0_ket_botttom.pdf}
    \caption[State $|0\rangle$ in the MI interferometer.]{State $\ket{0}$ is represented by a photon in the upper path.}
    \label{fig:m-z-upper}
\end{figure}
\begin{figure}[t]
   \centering
    \includegraphics[width=0.8\textwidth]{Figures/Chapter06/Color/1_ket_bottom.pdf}
...
\begin{figure}[t]
   \centering
    \includegraphics[width=0.8\textwidth]{Figures/Chapter06/Color/bottom_blocked.pdf}
