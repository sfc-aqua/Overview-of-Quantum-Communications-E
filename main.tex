...
\edition{This is not an official edition, but is instead a temporary facsicle made available only for review purposes on \today. It is very, very far from complete or even ready for human consumption. So far, Chapters 1-4, 6, 8 and 10 are ready for reading and feedback from \emph{friendly} reviewers. Also, the book is not being published by MIT Press, we are just building off of their \LaTeX template.}
