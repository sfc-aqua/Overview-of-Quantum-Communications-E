...
\xsimsetup{
  ...
  exercise/within = chapter % Numbers exercises by chapter (e.g., 1.1, 1.2)
}
...
\newcommand{\xmarksmall}{\ding[1]{56}}
...
%
\providecommand{\bra}[1]{%  dirac 'bra'
    \ensuremath{\left\langle #1 \right|}\xspace}

\providecommand{\ket}[1]{%  dirac 'ket'
    \ensuremath{\left|  #1 \right\rangle}\xspace}

\providecommand{\innp}[2]{%  dirac style inner product
    \ensuremath{\langle #1 \mid #2 \rangle}}

\providecommand{\outp}[2]{%  dirac style outer product
...
\providecommand{\ketbra}[2]{\ensuremath{|#1 \rangle \langle #2|}}
\providecommand{\ro}[1]{\ensuremath{|#1 \rangle \langle #1|}}
\providecommand{\av}[1]{\ensuremath{\langle #1 \rangle}}
\providecommand{\real}{\ensuremath{\mathrm{Re}}}
\providecommand{\trace}{\ensuremath{\textsf{Tr}}}

%% use the proper notation for CZ etc
\providecommand{\CZ}{\ensuremath{\wedge Z}\xspace}
\providecommand{\CX}{\ensuremath{\wedge X}\xspace}
\providecommand{\CNot}{\CX}
\providecommand{\cnot}{\textsc{cnot}\xspace}
\providecommand{\ccnot}{\textsc{ccnot}\xspace}

\providecommand{\PsiPlus}{\ensuremath{\ket{\Psi^+}}\xspace}
\providecommand{\PsiMinus}{\ensuremath{\ket{\Psi^-}}\xspace}
\providecommand{\PhiPlus}{\ensuremath{\ket{\Phi^+}}\xspace}
\providecommand{\PhiMinus}{\ensuremath{\ket{\Phi^-}}\xspace}

\providecommand{\sulPisP}{\ensuremath{\bra{\Psi^+}}\xspace}
\providecommand{\suniMisP}{\ensuremath{\bra{\Psi^-}}\xspace}
\providecommand{\sulPihP}{\ensuremath{\bra{\Phi^+}}\xspace}
\providecommand{\suniMihP}{\ensuremath{\bra{\Phi^-}}\xspace}
...
\edition{This is not an official edition, but is instead a temporary facsicle made available only for review purposes on \today. It is nearing completion and almost ready for human consumption. Feedback from \emph{friendly} reviewers always welcome! Also, the book is not being published by MIT Press, we are just building off of their \LaTeX template.}
...
\newline
\newline
For my wife and children, my three deterministic sources of bright light\\
---michal}
...
\input{CH02_Quantum-States}
\input{CH03_Pure-and-Mixed-States}
\input{CH04_Entanglement}

\part{Fundamentals of Optics}
\input{intro-block-2}
\input{CH05_Coherent-Light-and-Single-photons}
\input{CH06_Interference}
\input{CH07_Waveguides}

\part{Quantum Communication Protocols}
\input{intro-block-3}
\input{CH08_Teleportation}
\input{CH09_BB84}
\input{CH10_E91}

\part{Fundamentals of Quantum Repeaters}
\input{intro-block-4}
\input{CH11_Long-Distance-Communication}
\input{CH12_Quantum-Repeaters}
\input{CH13_Physical-Layer-Components}

\part{Quantum Repeater Systems}
\input{intro-block-5}
\input{CH14_Entanglement-Revisited}
\input{CH15_Quantum-Internet}
