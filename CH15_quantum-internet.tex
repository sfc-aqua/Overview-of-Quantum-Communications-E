...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\textwidth]{Figures/Chapter15/BW/15-1_Internet_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.5\textwidth]{Figures/Chapter15/BW/15-1_network_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=.5\textwidth]{Figures/Chapter15/BW/15-1_recursion_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\textwidth]{Figures/Chapter15/BW/15-2_integration_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=1\textwidth]{Figures/Chapter15/BW/15-2_distributed_BW.pdf}
...
\rrr We talked about routing protocols in the multi-level system that is the classical Internet earlier in this chapter, but also back in Chapter~\ref{sec:12_quantum_repeaters} when discussing individual quantum networks or single-level systems.
