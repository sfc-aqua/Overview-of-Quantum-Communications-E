...
% \begin{figure}[t]
%     \centering
%     \includegraphics[width=0.8\textwidth]{Figures/Chapter05/Color/5-1_underwater_cable_map.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Figures/Chapter05/BW/5-2_spontaneous_emission_BW.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/Chapter05/BW/5-2_incoherent_emission_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=0.55\textwidth]{Figures/Chapter05/BW/5-3_three_interactions_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{Figures/Chapter05/BW/5-3_population_inversion_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{Figures/Chapter05/BW/5-4_three-level-atom_BW.pdf}
...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{Figures/Chapter05/BW/5-4_laser_construction_BW.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{Figures/Chapter05/BW/5-4_lasing_BW.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{Figures/Chapter05/BW/5-5_single_photons_BW.pdf}
...
\begin{exercise}
\emph{Laser model.} We introduced our mathematical toy model of a laser. The rate of change of the number of photons inside the optical cavity, $n$, is given by
\begin{equation}
    \dot{n} = (G N_0 - k) n - \alpha G n^2,
\end{equation}
...
\begin{enumerate}[label=(\alph*)]
    \item By solving $\dot{n} = 0$, show that the there are two fixed points,
    \begin{equation}
        n_1^* = 0, \qquad \text{and }\qquad n_2^*=\frac{GN_0 - k}{\alpha}.
    \end{equation}
    Determine under what conditions are both of these fixed points physical.
    \item Stability of the fixed points can be determined by \emph{linearizing} around the fixed points\footnote{This is the same idea used in calculus to determine whether a stationary point of a function is a maximum or a minimum.}.
...
\begin{solution}
\begin{enumerate}[label=(\alph*)]
    \item In order to solve an equation of the form $ax^2+bx+c=0$, we apply the quadratic formula,
    \begin{align*}
    ...
    \item Computing the derivative of $\dot{n}$ with respect to $n$, we obtain
    \begin{equation*} 
        \frac{d\dot{n}}{dn}=GN_0-k-\alpha Gn.
    \end{equation*}
    Derivatives of $\dot{n}$ with respect $n$ at the fixed points are
    \begin{equation*}
        \left.\frac{d\dot{n}}{dn}\right|_{n^*_1}=GN_0-k, \quad \left.\frac{d\dot{n}}{dn}\right|_{n^*_2}=0.
    \end{equation*}
    ...
    The second fixed point only exists in the strong-pump regime, $GN_0>k$. By examining Fig.~\ref{fig:5-4_lasing}, we see that this fixed point is stable.
\end{enumerate}
\end{solution}

\begin{exercise}
\emph{Single photons via attenuation.} How many photons per second are in one milliwatt of laser power at a wavelength of 1550nm?  In order to solve this problem, you will need to know that the energy in a single photon is
\begin{equation}
    E = \frac{hc}{\lambda},
\end{equation}
...
\begin{enumerate}[label=(\alph*)]
    \item Assume an attenuator plate blocks 99\% of the incoming photons.
    ...
    \item How many attenuator plates are needed in order for the average number of photons per second to drop below 1?
\end{enumerate}
\end{exercise}
\begin{solution}
...
\begin{enumerate}[label=(\alph*)]
    \item \begin{enumerate}[label=(\roman*)]
        \item 1 attenuator plate: $7.8\times10^{15} \times 0.99=7.8\times10^{13}$.
        \item  2 attenuator plate: $7.8\times10^{15} \times 0.99^2=7.8\times10^{11}$.
        \item $m$ attenuator plate: $7.8\times10^{15} \times 0.99^m$.
    \end{enumerate}
    \item We are looking for an integer $m$ such that
    \begin{align*}
        7.8\times10^{15} \times 0.99^m & \leq 1 \\
        0.99^m & \leq 7.8\times10^{-15} \\
        \ln (0.99)^m & \leq \ln (7.8\times10^{-15}) \\
        m\ln (0.99) & \leq \ln (7.8\times10^{-15}) \\
        m & \leq \frac{\ln (7.8\times10^{-15})}{\ln (0.99)} = 3640.96.
    \end{align*}
    Tehrefore, we require at least $m=3641$ attenuators in order for the average number of photons per second to drop below 1. 
\end{enumerate}
\end{solution}
