...
Welcome to Lesson 1 on "Overview of Quantum Communications".
In this lesson, we will give you an overview of how communication evolved over the many thousands of years. 
...
We will conclude this lesson by giving you an overview of the entire module, what are the prerequisites, what you will learn, and what are the outcomes of the module.
...
Before concluding the first lesson, let's have a brief look at the structure of this module.
The next three lessons deal with the basics of quantum mechanics relevant to quantum communication.
...
Lessons 5-7 deal with basics of optics.
...
We will conclude this block of lessons by learning about waveguides and how light is guided in a network.

Lessons 8-10 look at fundamental quantum communication protocols.
...
In Lessons 11-13, we will look at the basics of quantum repeaters, a quantum technology that makes long-distance quantum communication possible.
The last two lessons look at quantum repeater systems.

There are some basic prerequisites for this module such as linear algebra (meaning vector and matrix multiplication; eigenvectors and eigenvalues; also, we will use the tensor product which will be introduced in this book), discrete probability, complex numbers (e.g., $i = \sqrt{-1}$ and Euler's equation, $e^{i\pi} + 1 = 0$), and it's very helpful if you have some introduction to quantum computing, and programming and classical computing, and if you know a little bit about computer networks that's very helpful as well.
...
If you would like to learn a little bit more about some basic linear algebra you can have a look at the playlist on Professor Van Meter's YouTube channel, or there are many other courses available.
