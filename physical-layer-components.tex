...
In this encoding, we encode our qubit in a state \ket{0} as a single photon that's polarized in the vertical direction, and our other computational basis state one, as a single photon polarized in the horizontal direction.
