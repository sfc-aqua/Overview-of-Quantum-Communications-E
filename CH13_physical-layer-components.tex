...
\begin{figure}[t]
    ...
    \caption{Caption}
    \label{fig:13-2_measurementZ}
\end{figure}

Let's step back a little and consider something simpler first, like measuring a single qubit in the Pauli $Z$ basis.
...
One place to learn more is Prof. Van Meter's book,
